...
final class HelperTargetPackagingTests: XCTestCase {
    func testHelperTargetIsAnEmbeddedAgentAppWithoutHostOnlyServices() throws {
        ...
        for configuration in helperConfigurations {
            ...
            XCTAssertTrue(configuration.contains("ASSETCATALOG_COMPILER_APPICON_NAME = AppIcon;"))
        }
        ...
        XCTAssertTrue(project.contains("A70000000000000000000002 /* Assets.xcassets in Resources */"))
